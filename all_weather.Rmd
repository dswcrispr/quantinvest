...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  ...
  geom_line(aes(y = GLD, color = 'GLD')) + geom_line(aes(y = DBC, color = 'DBC')) +         ylab('') + xlab('') + ggtitle('as of 2020.07.10(2019.06.05 = 100)') +
...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  ...
  xlab('') + ggtitle('as of 2020.07.10(2019.06.05 = 100)') + theme(legend.title = element_blank()) 
