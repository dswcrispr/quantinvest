...
a_year_ago = which(index(prices) == '2019-6-05')
now = dim(prices)[1]
...
# Graph
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  geom_line(aes(y = TLT, color = 'TLT')) + geom_line(aes(y = IEF, color = 'IEF')) + 
  geom_line(aes(y = GLD, color = 'GLD')) + geom_line(aes(y = DBC, color = 'DBC')) +         ylab('') + xlab('') + ggtitle('as of 2020.06.06(2019.06.05 = 100)') +
...
# Graph
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  geom_line(aes(y = IEV, color = 'IEV')) + geom_line(aes(y = EWJ, color = 'EWJ')) +
  geom_line(aes(y = EEM, color = 'EEM')) + geom_line(aes(y = TLT, color = 'TLT')) +
  geom_line(aes(y = IEF, color = 'IEF')) + geom_line(aes(y = IYR, color = 'IYR')) +
  geom_line(aes(y = RWX, color = 'RWX')) + geom_line(aes(y = GLD, color = 'GLD')) +
  geom_line(aes(y = DBC, color = 'DBC')) +   ylab('') +
  xlab('') + ggtitle('as of 2020.06.06(2019.06.05 = 100)') + theme(legend.title = element_blank()) 
