...
a_year_ago = which(index(prices) == '2020-03-2')
now = dim(prices)[1]
...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  ...
  geom_line(aes(y = GLD, color = 'GLD')) + geom_line(aes(y = DBC, color = 'DBC')) +         ylab('') + xlab('') + ggtitle('as of 2021.3.26(2020.3.2 = 100)') +
...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = QQQ, color = 'QQQ')) +
  ...
  xlab('') + ggtitle('as of 2021.3.26(2020.03.2 = 100)') + theme(legend.title = element_blank()) 
