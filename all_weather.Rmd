...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  ...
  geom_line(aes(y = GLD, color = 'GLD')) + geom_line(aes(y = DBC, color = 'DBC')) +         ylab('') + xlab('') + ggtitle('as of 2020.8.2(2019.8.2 = 100)') +
...
ggplot(prices_norm, aes(x = Index)) + geom_line(aes(y = VTI, color = 'VTI')) +
  ...
  xlab('') + ggtitle('as of 2020.08.2(2019.08.2 = 100)') + theme(legend.title = element_blank()) 
